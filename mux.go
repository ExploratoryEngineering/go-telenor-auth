...
const (
	...
	SessionContext contextKey = "apigee-session"
)
...
func (t *TelenorAuth) NewAuthHandlerFunc(existingFunc http.HandlerFunc) http.HandlerFunc {
...
func (a *authHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	auth, session := a.auth.isAuthorized(w, r)
	if !auth {
		return
	}
...
// Context.
func (t *TelenorAuth) NewAuthHandler(existingHandler http.Handler) http.Handler {
	return &authHandler{auth: t, existingHandler: existingHandler}
}
